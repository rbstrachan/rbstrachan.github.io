...
| :--- | :--- |
| **Harassment&nbsp;&&nbsp;Discrimination**<br>&nbsp; | Any form of verbal abuse, harassment or discrimination based on race, gender, religion, sexual orientation, disability or national origin. |
| **Inappropriate Content**<br>&nbsp; | The sharing of sexually explicit, violent or otherwise offensive materials during sessions. |
| **Intoxication** | Attending lessons while under the influence of alcohol or recreational drugs. |
| **Aggression** | Any form of threatening behaviour, intimidation or persistent hostility. |

## Learning Environment
To ensure the best pedagogical outcomes, Students are encouraged to follow these guidelines:

| Area | Expectation |
| :--- | :--- |
| **Minimize&nbsp;Distractions** | Attend lessons from a quiet, private location with minimal background noise. |
| **Preparation** | Engage with the lesson materials and come prepared to participate actively. |
