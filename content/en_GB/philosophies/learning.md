...
Naturally, we find ourselves looking to others for guidance, but I propose that there are two opposite, yet related, roadblocks to be encountered.

While seemingly obvious, it bears remarking that those who have not reached sufficient proficiency cannot guide you there because they themselves have not yet achieved it. Conversely, those who *are* naturally or effortlessly proficient often cannot guide you because they do not understand the mechanics of their own success.[^8]

In almost any field, you are likely to encounter so-called "unconscious competents"[^6] — people who have studied and practised a subject for so long, to have achieved a level of proficiency so high, that they can exercise thought in their subject without much, if any, conscious effort. Take bilingual people, for example. From their perspective, their skill is either an accident of circumstance or indeed a long-forgotten process. They have mastered the subject, but they cannot remember, much less *explain*, how. They don't remember the struggle of their first steps, nor much the specific problems they encountered along the way. Pain and struggle as experiences are easy to forget and you cannot effectively teach what you no longer consciously understand. Asking a natural expert for a technical breakdown of their intuition is like asking a bird how it calculates wind resistance; it just flies.

It's important to understand that no resource, no matter how hard it may try to convince you otherwise — including this website — can be a step-by-step instruction manual to expertise. Research has continuously shown that, quote;
...
The Social Model of Disability[^12] argues that 'disability' is simply a mismatch between a person's needs and their environment's resources, rather than an inherent flaw in the person. I agree completely with this model.

It is vital to understand that *accessible* is not synonymous with *simplified*. Making a resource accessible should rarely mean providing less or simpler content. For example, adding patterns to a colour-coded chart for a colour-blind user or providing a screen-reader-compatible version of a complex data set makes the information accessible, but it doesn't change the complexity of the data itself. People with accessibility needs are not looking for easier content; they are looking for the same content delivered through a functional interface in a way they can use and understand. To that end, I believe that the integrity of an educational system should be measured by its ability to remain accessible without being simplified.
...
Practising a mistake will only habitualise that mistake, creating cognitive debt that must be repaid with interest later. Refining your skills and expanding your knowledge requires not only practice, but *perfect* practice.

[^1]: CAST. (2024). [Universal Design for Learning Guidelines Version 3.0](https://udlguidelines.cast.org/representation/)
[^3]: United Nations. [Universal Declaration of Human Rights — Article 19](https://www.un.org/en/about-us/universal-declaration-of-human-rights)
[^4]: International Federation of Library Associations and Institutions. (2005). [Alexandria Proclamation on Libraries, the Information Society in Action](https://repository.ifla.org/rest/api/core/bitstreams/cc8ef793-003f-445b-a662-d0fee57df04c/content)
[^5]: [The Cape Town Open Education Declaration](https://www.capetowndeclaration.org/read/). (2007).
[^6]: Gordon Training International. [Learning a New Skill is Easier Said than Done: The 4 Stages of Learning](https://www.gordontraining.com/free-workplace-articles/learning-a-new-skill-is-easier-said-than-done/).
[^7]: University at Buffalo Office of Curriculum, Assessment & Teaching Transformation. [Constructivism](https://www.buffalo.edu/catt/teach/develop/theory/constructivism.html)
[^8]: Nathan, M. J., & Koedinger, K. R. (2000). [Expert Blind Spot: When Content Knowledge and Pedagogical Content Knowledge Collide](https://www.colorado.edu/ics/sites/default/files/attached-files/00-05.pdf). University of Colorado Boulder.
[^9]: Rose, T. (2013). [The Myth of Average: Todd Rose at TEDxSonomaCounty](https://www.youtube.com/watch?v=4eBmyttcfU4) (YouTube)
[^10]: National Education Association (NEA). (2016). [Dismantling the Myth of the "Average" Student](https://www.nea.org/nea-today/all-news-articles/dismantling-myth-average-student)
[^11]: Singer, J. (2017). [Neurodiversity : The Birth of an Idea](https://discovered.ed.ac.uk/discovery/fulldisplay/alma9924298553202466/44UOE_INST:44UOE_VU2)
[^12]: Oliver, M. (2004). [The Social Model in Action: If I Had a Hammer](https://disability-studies.leeds.ac.uk/wp-content/uploads/sites/40/library/Barnes-implementing-the-social-model-chapter-2.pdf). In *Implementing the Social Model of Disability: Theory and Research*
[^13]: Holmes, K. (2020). [Mismatch: How Inclusion Shapes Design](https://mitpress.mit.edu/9780262539487/mismatch/). MIT Press.
[^14]: NC State University Centre for Universal Design. (1997). [The 7 Principles of Universal Design: Equitable Use](https://universaldesign.ie/what-is-universal-design/the-7-principles/)
[^15]: Ericsson, K. A., Krampe, R. T., & Tesch-Römer, C. (1993). [The role of deliberate practice in the acquisition of expert performance](https://www.researchgate.net/publication/224827585_The_Role_of_Deliberate_Practice_in_the_Acquisition_of_Expert_Performance). Psychological Review, 100(3), 363–406.